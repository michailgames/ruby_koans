...
class AboutSymbols < Neo::Koan
  ...
  # The symbol :test_method_names_become_symbols will probably be a different symbol
  # than the method symbol
  ...
  # They stay in a memory for a whole program lifecycle
end
