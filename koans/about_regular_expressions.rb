...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When there is something before/after * that can't match
  end
  ...
  #
  # Why?
  # They always try to match as much as possible.
  # ------------------------------------------------------------------
  ...
  # Character class can be seen as a special case of alternation
  # ------------------------------------------------------------------
